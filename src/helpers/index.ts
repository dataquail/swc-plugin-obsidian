...
export function paramsToDestructuringAssignment(params: Param[]): Param {
  ...
  return newParam;
  // const identifierParams = params.filter((p) => p.pat.type === "Identifier");
  // const keyValuePatternPropertyList = identifierParams.map((p): KeyValuePatternProperty => ({
  //   type: "KeyValuePatternProperty",
  //   key: {
  //     type: "Identifier",
  //     value: p.value,
  ...
  // return {
  //   type: "ObjectPattern",
  //   properties: keyValuePatternPropertyList,
  //   span: params[0].span,
  //   optional: false,
  // }
}
